    ...
    <body id="page1">
        <div class="extra">
            ...
            <header>
                ...
                <%
                    String busdetail = "";
                    if (session.getAttribute("busdetail") != null) {
                        busdetail = session.getAttribute("busdetail").toString();
                    }
                %>
                <center><h4><%= busdetail%></h4><% session.removeAttribute("busdetail");%></center>
                <div class="row-bot">
                                    ...
                                    <table allign="right">
                                        ...
                                        <tr>
                                            ...
                                            <td><select name="bus_type">
                                                    <option value="Select Root ID">Select Bus Type</option>
                                        ...
                                        <tr>
                                            ...
                                            <td><select name="route_id">
                                                    <option value="Select Route ID">Select Route ID</option>
                                                    <%
                                                        Connection con = DBConnection.getConnection();
                                                        Statement st = con.createStatement();
                                                        String query = "select routeid from bus_route";
                                                        ResultSet rs = st.executeQuery(query);
                                                        String root_id;
                                                        while (rs.next()) {
                                                            root_id = rs.getString("routeid");
                                                    %> 
                                                    <option value="<%=root_id%>"><%=root_id%></option>
