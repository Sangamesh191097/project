                    ...
                    <div class="center-shadow">
                        <div class="carousel-container">
                            <div id="carousel">
                                ...
                                <table id="customers">
                        <tr><td>CID</td><td>First name</td><td>Last Name</td><td>Contact</td>
                            <td>Route ID</td><td>Bus ID</td>
                        ...
                        <%
                            ...
                            ResultSet rs=db.get_all_conductor_details();
                            ...
                            %>
                           <form action="./delete_conductor" method="post">
                           <input type="hidden" name="cid" value="<%=rs.getString("cid")%>"/>
                        
                               
                         <tr><td><%=rs.getString("cid")%></td>
